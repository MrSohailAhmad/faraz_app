    ...
    <header className="header">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="widget no-border m-0">
                <ul className="styled-icons icon-dark icon-circled icon-theme-colored icon-sm pull-right sm-pull-none sm-text-center mt-sm-15">
                  <li>
                    <a href="#">
        ...
        <div className="container pt-0 pb-0">
          <div className="row">
            <div className="col-xs-12 col-sm-4 col-md-5">
              <div className="widget no-border m-0">
                <a
                  className="menuzord-brand xs-pull-center mb-15"
            ...
            <div className="col-xs-12 col-sm-4 col-md-4">
              <div className="widget no-border m-0">
                <div className="mt-10 mb-10 text-right sm-text-center">
                  <div className="font-20 text-black-333 text-uppercase mb-5 font-weight-600">
                    <i className="fa fa-phone-square text-theme-colored font-24"></i>{" "}
                    +(012) 345 6789
                  </div>
                  <a className="font-12 text-gray" href="#">
            ...
            <div className="col-xs-12 col-sm-4 col-md-3">
              <div className="widget no-border m-0">
                <div className="mt-10 mb-10 text-right sm-text-center">
                  <div className="font-20 text-black-333 text-uppercase mb-5 font-weight-600">
                    <i className="fa fa-envelope text-theme-colored font-24"></i>{" "}
                    Mail us today
                  </div>
                  <a className="font-12 text-gray" href="#">
                    {" "}
      ...
      <div className="header-nav">
        <div className="header-nav-wrapper navbar-scrolltofixed bg-light">
          <div className="container">
            <nav id="menuzord" className="menuzord default bg-light">
              <ul className="menuzord-menu">
                  ...
                  <ul className="dropdown">
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="index-mp-layout6.html">Layout6</a>
                        </li>
                        <li>
                          <a href="index-mp-layout7.html">Layout7</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="index-sp-layout6.html">Layout6</a>
                        </li>
                        <li>
                          <a href="index-sp-layout7.html">Layout7</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="index-boxed-mp-layout6.html">
                            Boxed Multi Page Layout6
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="index-boxed-sp-layout6.html">
                            Boxed Single Page Layout6
                          </a>
                        </li>
                        <li>
                          <a href="index-boxed-sp-layout7.html">
                            Boxed Single Page Layout7
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="index-rtl-mp-layout6.html">
                            RTL Multi Page Layout6
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="index-rtl-sp-layout6.html">
                            RTL Single Page Layout6
                          </a>
                        </li>
                        <li>
                          <a href="index-rtl-sp-layout7.html">
                            RTL Single Page Layout7
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="index-dark-mp-layout6.html">
                            Dark Multi Page Layout6
                          </a>
                        </li>
                        <li>
                          <a href="index-dark-mp-layout7.html">
                        ...
                        <li>
                          <a href="index-dark-sp-layout6.html">
                            Dark Single Page Layout6
                          </a>
                        </li>
                        <li>
                          <a href="index-dark-sp-layout7.html">
                            Dark Single Page Layout7
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a href="#">Magazine Home Layouts</a>
                      <ul className="dropdown">
                        <li>
                          <a href="index-magazine-home-layout1.html">
                            Magazine Home layout1
                          </a>
                        </li>
                        <li>
                          <a href="index-magazine-home-layout2.html">
                    ...
                    <li>
                      <a href="#">Portfolio Home Layouts</a>
                      <ul className="dropdown">
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="index-hot-split-slider-home.html">
                            Split Slider Home Layout
                          </a>
                        </li>
                        <li>
                          <a href="index-hot-vertical-slider-home.html">
                            Vertical Slider Home Layout
                          </a>
                        </li>
                        <li>
                          <a href="index-hot-fullscreen-home.html">
                            Fullscreen Home Layout
                          </a>
                        </li>
                        <li>
                          <a href="index-hot-parallax-home.html">
                            Parallax Home Layout
                          </a>
                        </li>
                        <li>
                          <a href="index-hot-personal-home.html">
                    ...
                    <li>
                      <a href="index-hot-shop-home.html">Shop Home</a>
                    </li>
                    <li>
                  ...
                  <ul className="dropdown">
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="features-header-style7.html">
                            Header Style7
                          </a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="features-page-title-full-transparent.html">
                            Full Transparent
                          </a>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          ...
                          <ul className="dropdown">
                            <li>
                              <a href="page-contact-style1.html">
                                Contact style 1
                              </a>
                            </li>
                            <li>
                              <a href="page-contact-style2.html">
                                Contact style 2
                              </a>
                            </li>
                            <li>
                              <a href="page-contact-style3.html">
                                Contact style 3
                              </a>
                            </li>
                            <li>
                              <a href="page-contact-style4.html">
                                Contact style 4
                              </a>
                            </li>
                            <li>
                              <a href="page-contact5-with-multiple-marker.html">
                                Contact style 5 with multiple marker
                              </a>
                            </li>
                            <li>
                              <a href="page-contact6-with-multiple-marker.html">
                                Contact style 6 with multiple marker
                              </a>
                            </li>
                          </ul>
                        </li>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="features-popup-promo-box.html">Default</a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="features-footer-style1.html#footer">
                            Footer Dark One
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style2.html#footer">
                            Footer Dark Two
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style3.html#footer">
                            Footer Dark Three
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style4.html#footer">
                            Footer Dark Four
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style5.html#footer">
                            Footer Dark Five
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style6.html#footer">
                            Footer Dark Six
                          </a>
                        </li>
                        <li>
                          <a href="features-footer-style7.html#footer">
                            Footer Dark Seven
                          </a>
                        </li>
                      </ul>
                  ...
                  <ul className="dropdown">
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="page-our-impact.html">Our Impact</a>
                        </li>
                        <li>
                          <a href="page-story.html">Story</a>
                        </li>
                        <li>
                          <a href="page-mission.html">Mission</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="page-causes-grid-3-column.html">
                            Causes 3 Column
                          </a>
                        </li>
                        <li>
                          <a href="page-causes-grid-4-column.html">
                            Causes 4 Column
                          </a>
                        </li>
                        <li>
                          <a href="page-causes-list.html">Causes List</a>
                        </li>
                        <li>
                          <a href="page-single-cause.html">Single Cause</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="page-volunteer-3column.html">
                            Volunteer 3column
                          </a>
                        </li>
                        <li>
                          <a href="page-volunteer-4column.html">
                            Volunteer 4column
                          </a>
                        </li>
                        <li>
                          <a href="page-volunteer-details.html">
                            Volunteer Details
                          </a>
                        </li>
                      </ul>
                    ...
                    <li>
                      <a href="#">
                        Shop <span className="label label-info">New</span>
                      </a>
                      <ul className="dropdown">
                        <li>
                    ...
                    <li>
                      <a href="#">
                        Job <span className="label label-info">New</span>
                      </a>
                      <ul className="dropdown">
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="dropdown">
                        ...
                        <li>
                          <a href="page-under-construction-style4.html">
                            Style4
                          </a>
                        </li>
                      </ul>
                ...
                <li>
                  ...
                  <ul className="dropdown">
                    <li>
                      <a href="#">Gallery Boxed</a>
                      <ul className="dropdown">
                        <li>
                          <a href="page-gallery-boxed-2col.html">2 Columns</a>
                        </li>
                        <li>
                          <a href="page-gallery-boxed-3col.html">3 Columns</a>
                        </li>
                        <li>
                          <a href="page-gallery-boxed-4col.html">4 Columns</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="dropdown">
                        <li>
                          <a href="page-gallery-fullwidth-2col.html">
                            2 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-fullwidth-3col.html">
                            3 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-fullwidth-4col.html">
                            4 Columns
                          </a>
                        </li>
                      </ul>
                    ...
                    <li>
                      <a href="#">Gallery Boxed With Caption</a>
                      <ul className="dropdown">
                        <li>
                          <a href="page-gallery-boxed-with-caption-2col.html">
                            2 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-boxed-with-caption-3col.html">
                            3 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-boxed-with-caption-4col.html">
                            4 Columns
                          </a>
                        </li>
                      </ul>
                    ...
                    <li>
                      <a href="#">Gallery Fullwidth With Caption</a>
                      <ul className="dropdown">
                        <li>
                          <a href="page-gallery-fullwidth-with-caption-2col.html">
                            2 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-fullwidth-with-caption-3col.html">
                            3 Columns
                          </a>
                        </li>
                        <li>
                          <a href="page-gallery-fullwidth-with-caption-4col.html">
                            4 Columns
                          </a>
                        </li>
                      </ul>
                ...
                <li>
                  ...
                  <ul className="dropdown">
                    <li>
                      <a href="page-event-list.html">Event List</a>
                    </li>
                    <li>
                      <a href="page-event-grid-3column.html">Event 3column</a>
                    </li>
                    <li>
                      <a href="page-event-grid-4column.html">Event 4column</a>
                    </li>
                    <li>
                      <a href="page-single-event.html">Single Event</a>
                    </li>
                    <li>
                      <a href="page-event-calendar.html">Event Calendar</a>
                    </li>
                  </ul>
                </li>
                <li>
                          ...
                          <div className="entry-header">
                            <div className="post-thumb">
                              <img
                                ...
                                src="images/blog/mega-menu.jpg"
                                alt="mdkfsk"
                              />
                            </div>
                          </div>
                          <div className="post-details">
                            <h4 className="entry-title mt-10">
                              <a href="#">Featured News Title Here</a>
                            </h4>
                            <p className="">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit, sed do eiusmod tempor incididunt ut labore
                              et dolore magna et sed aliqua
                        ...
                        <div className="list-dashed">
                          <article className="post media-post clearfix pb-0 mb-10">
                            ...
                            <a href="#" className="post-thumb">
                              <img alt="" src="images/blog/square1.jpg" />
                            </a>
                          ...
                          <article className="post media-post clearfix pb-0 mb-10">
                            {" "}
                            <a href="#" className="post-thumb">
                              <img alt="" src="images/blog/square2.jpg" />
                            </a>
                            <div className="post-right">
                              <h5 className="post-title mt-0">
                                <a href="#">
                                  Assertive and Persistent Advocacy
                                </a>
                              </h5>
                              <p>Jun 23, 2015</p>
                            </div>
                          ...
                          <article className="post media-post clearfix pb-0 mb-10">
                            {" "}
                            <a href="#" className="post-thumb">
                              <img alt="" src="images/blog/square3.jpg" />
                            </a>
                            <div className="post-right">
                              <h5 className="post-title mt-0">
                        ...
                        <ul className="list-unstyled list-dashed">
                          ...
                          <li>
                            <a href="shortcode-blockquotes.html">
                              <i className="fa fa-quote-right"></i> Blockquotes
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-buttons.html">
                              <i className="fa fa-external-link"></i> Buttons
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-columns-grids.html">
                              <i className="fa fa-columns"></i> Columns Grids
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className="list-unstyled list-dashed">
                          ...
                          <li>
                            <a href="shortcode-icon-7stroke.html">
                              <i className="fa fa-circle-o"></i> Icons 7stroke
                            </a>
                          </li>
                          <li>
                            <a href="shortcode-icon-elegant-icons.html">
                              <i className="fa fa-eye-slash"></i> Icons Elegant
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-icon-strokegap.html">
                              <i className="fa fa-anchor"></i> Icons Strokegap
                            </a>
                          </li>
                          <li>
                            <a href="shortcode-image-box.html">
                              <i className="fa fa-file-image-o"></i> Image Box
                            </a>
                          </li>
                          <li>
                            <a href="shortcode-instagram.html">
                              <i className="fa fa-instagram"></i> Instagram Feed
                            </a>
                          </li>
                          <li>
                            <a href="shortcode-labels-badges.html">
                              <i className="fa fa-check-square-o"></i> Labels
                              Badges
                            </a>
                          </li>
                        </ul>
                        ...
                        <ul className="list-unstyled list-dashed">
                          <li>
                            <a href="shortcode-listgroup-panels.html">
                              <i className="fa fa-th-list"></i> Listgroup Panels
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-separator.html">
                              <i className="fa fa-minus-square-o"></i> Separator
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className="list-unstyled list-dashed">
                          <li>
                            <a href="shortcode-styled-icons.html">
                              <i className="fa fa-facebook-square"></i> Styled
                              Icons
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-timer-final-countdown.html">
                              <i className="fa fa-text-height"></i> Timer Final
                              Countdown
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-timer-slick-circular.html">
                              <i className="fa fa-text-height"></i> Timer Slick
                              Circular
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="shortcode-working-process.html">
                              <i className="fa fa-exchange"></i> Working Process
                            </a>
                          </li>
                        </ul>
                      </div>
              ...
              <ul className="pull-right hidden-sm hidden-xs">
                <li>
                  <a
                    className="btn btn-colored btn-flat btn-theme-colored mt-15 ajaxload-popup"
